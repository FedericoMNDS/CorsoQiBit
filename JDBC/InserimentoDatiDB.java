...
public class InserimentoDatiDB {
    ...
    private static void Menu() {
        CreazioneBiblioteca.Inizialize();
        System.out.println("\nBenvenuto nel programma Biblioteca!");
    ...
    private static void SceltaStampaLibri(Connection connection) {
        try {
            ...
            boolean tuttiLibri;
            while (true) {
                autore = RilevaInputUtenteString(
                        "Inserisci il nome dell'autore oppure lascia in bianco per visualizzare tutti i libri");
